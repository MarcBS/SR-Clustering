...
# Data parameters
path_images = '/media/marcvaldivia/HDD/EDUB-Seg/images'
folders = ['SubjectR_SetR']
formats = ['.jpg']

# Result parameters
path_result = '/home/marcvaldivia/code/SR-Clustering/Concept_Detector/tmp/tags'
path_output_lists = '/home/marcvaldivia/code/SR-Clustering/Concept_Detector/tmp/list_clusters'
