...
folder = ['/media/marcvaldivia/HDD/EDUB-Seg/images/Subject1_Set3'];
...
GT_path = ['/media/marcvaldivia/HDD/EDUB-Seg/GT/GT_Subject1_Set3.xls'];

%% The R-Clustering segmentation is applied
[segmentation, result] = RClustering(folder, images_format, data_params, R_Clustering_params, CNN_params, Semantic_params, plot_params, GT_path);
