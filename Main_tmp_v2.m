...
for i_fold=1:length(folders)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    path2concepts = [directorio_im '/' camera{i_fold} '/LSDAfeatures/'];
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    elseif strcmp(paramsfeatures.type, 'CNN') ||  strcmp(paramsfeatures.type, 'CNNconcepts') 
         load([path2concepts 'LSDAfeatures_' folder '_v' num2str(version_concepts) '.mat']);%this load a variable called 'LSDAfeatures'
         load(path_features);%this load a variable cald 'features'
	    ...
	    composite_features = featuresPCA;
	    %composite_features = [featuresPCA,LSDAfeatures(:,30)];
            %composite_features = [featuresPCA,LSDAfeatures(:,1:30)];
            %composite_features = [featuresPCA,LSDAfeatures];
	end
    end 
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%                 RPAF_Clustering.fMeasure_Events = FM_Clust;
                ...
                elseif(paramsPCA.usePCA_GC && strcmp(paramsfeatures.type, 'CNNconcepts'))
                    ...
                    features_GC = [features, LSDAfeatures];
                end
